<?php
    ...
    $id=$_GET['id'];
    $cliente="SELECT * FROM cliente WHERE Id=$id";
    $cliente2=mysqli_query($conexao,$cliente);
    $cliente3 = mysqli_fetch_assoc($cliente2);
  ...
  <body>
    <!--botão para ir para a página de listagem-->
     ...
     <div class="pricing-header px-3 py-3 pt-md-3 pb-md-4 mx-auto text-center">
        <h4 class="display-6">Por favor, edite o cliente a seguir</h4>
     </div>
...
<form method="POST">
  <div class="form-group">
    <label>Nome</label>
    <input type="text" class="form-control" required name="nome" value="<?php echo $cliente3['nome']; ?>">
  </div>
  <div class="form-row">
    <div class="form-group col-md-3">
      <label>CPF</label>
      <input type="text" class="form-control" id="cpf" maxlength="11" required name="cpf" value="<?php echo $cliente3['cpf']; ?>">
    ...
    <div class="form-group col-md-3">
      <label>RG</label>
      <input type="text" class="form-control" id="rg" required maxlength="9" name="rg" value="<?php echo $cliente3['rg']; ?>">
    ...
    <div class="form-group col-md-3">
      ...
      <input type="text" class="form-control" id="telefone" name="telefone" maxlength="10" value="<?php echo $cliente3['tel']; ?>">
    ...
    <div class="form-group col-md-3">
      <label>Celular</label>
      <input type="text" class="form-control" id="celular" required name="celular" maxlength="11" value="<?php echo $cliente3['celular']; ?>">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="logradouro" required name="logradouro" value="<?php echo $cliente3['logra']; ?>">
  </div>
  <div class="form-row">
    <div class="form-group col-md-3">
      <label>Número</label>
      <input type="text" class="form-control" id="numero" required name="numero" value="<?php echo $cliente3['numero']; ?>">
      <!-- mensagem de erro caso o campo não seja puramente numérico-->
    ...
    <div class="form-group col-md-3">
      ...
      <input type="text" class="form-control" id="complemento" name="complemento" value="<?php echo $cliente3['comple']; ?>">
    </div>
    <div class="form-group col-md-3">
      <label>Bairro</label>
      <input type="text" class="form-control" id="bairro" name="bairro" value="<?php echo $cliente3['bairro']; ?>">
    </div>
    <div class="form-group col-md-3">
      <label>CEP</label>
      <input type="text" class="form-control" id="cep" required maxlength="8" name="cep" value="<?php echo $cliente3['cep']; ?>">
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-5">
      <label>Email</label>
      <input type="email" class="form-control" id="email" required name="email" value="<?php echo $cliente3['email']; ?>">
    </div>

  </div>
  <!-- Boão para cadastrar as informações -->                    
  <button class="btn btn-primary" type="submit" style="float: right;">Editar</button>
    ...
    <?php
          ...
          //Atualizando as informações na tabela 'cliente'
          if($contador==6)//contador dos campos numéricos
          {
            $sqlEdit="UPDATE cliente SET nome='$nome',cpf='$cpf',rg='$rg',tel='$telefone',celular='$celular',email='$email',
                cidade='".$cidade3["Nome"]."',estado='".$estado3["Uf"]."',logra='$logradouro',numero='$numero',comple='$complemento',
                bairro='$bairro',cep='$cep' WHERE id='$id'";
            if(mysqli_query($conexao, $sqlEdit))
            {
            ...
            {
                echo "Error: " . $sqlEdit . "<br>" . mysqli_error($conexao);
            }
